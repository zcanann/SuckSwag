namespace SuckSwag.Source.Mvvm.Messaging
{
    ...
    /// <summary>
    /// Provides a message class with a built-in callback. When the recipient is done processing the message, it can execute the callback to notify the sender
    /// that it is done. Use the <see cref="Execute" /> method to execute the callback. The callback method has one parameter. <seealso cref="NotificationMessageAction"/>.
    /// </summary>
    /// <typeparam name="TCallbackParameter">The type of the callback method's only parameter.</typeparam>
    internal class NotificationMessageAction<TCallbackParameter> : NotificationMessageWithCallback
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationMessageAction&lt;TCallbackParameter&gt;" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <param name="parameter">A parameter requested by the message'ssender and providing additional information on the recipient's state.</param>
